...
def get_em_data(*, read_blockchain: bool = False):
    ...
    if read_blockchain:  # Will use the moralis APIs to query the blockchian.  Takes 10 sec or so.
        ...
        em_data['redemption_queue'] = 1.50E6
        em_data['trunk_supply'] = 31.195E6
        em_data['staking_balance'] = 8.509E6
        stampede_bonds = 56.37E6
        stampede_payouts = 60.63E6
        em_data['farm_tvl'] = 7.564E6  # Yield is paid out on TVL
        em_data['farm_balance'] = em_data['farm_tvl'] / 2  # This is the total trunk balance in the farms
        farm_depot_tvl = 101513  # In Trunk, TODO: should be able to read this automatically
        farm_depot_claimed = 969771  # In Trunk
        ...
        em_data['em_futures'] = bsc.BUSDFuturesEngine(726645)  # Create futures engine
        ...
        f_o = open('chain_data/emData_2023-01-24 19:15.pkl', 'rb')  # TODO: figure out how to update this automatically
