...
def get_em_data(*, read_blockchain: bool = False):
    ...
    if read_blockchain:  # Will use the moralis APIs to query the blockchian.  Takes 10 sec or so.
        ...
        ave_ele_price = (em_data['ele_bnb_lp'].price * em_data['bnb'].usd_value + em_data['ele_busd_lp'].price) / 2
        ...
        em_data['stampede_max_apr'] = 2.05 / 365
        em_data['redemption_queue'] = 1.46E6
        em_data['trunk_supply'] = 30.329E6
        em_data['staking_balance'] = 9.152E6
        em_data['stampede_bonds'] = 55.73E6
        em_data['stampede_payouts'] = 58.85E6
        ...
        em_data['stampede_owed'] = 2.05 * em_data['stampede_bonds'] - em_data[
            'stampede_payouts']  # Total platform debt as of "today"
        ...
        em_data['trunk_total_debt'] = em_data['trunk_liquid_debt'] + em_data['stampede_owed']
        ...
        f_o = open('chainData_2023-01-06.pkl', 'rb')  # TODO: figure out how to update this automatically
